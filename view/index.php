    ...
    <tbody>
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                echo "<a href='delete.php?id=" . $row['id'] . "' onclick=\"return confirm('Apakah Anda yakin ingin menghapus item ini?')\" class='btn-delete'>Delete</a>";
                }
                echo "</td>";
                echo "</tr>";
            }
...
<a href="controller/logout.php" class='logout-link'>Logout</a>  
